...
@RestController("lang.variable.exam1")   // 클래스 이름이 같은 경우 충돌 방지 (이름표 마음대로 해도된다)
...
public class Exam1 {
  ...
  // 테스트 URL
  // http://localhost:8080/lang/variable/exam1/test1?name=%ED%99%8D%EA%B8%B8%EB%8F%99&tel=010-1234-5678&gender=man  
  @GetMapping("/test1")
  ...
  // 테스트 URL
  // http://localhost:8080/lang/variable/exam1/test2?b=100&s=32767&i=2100000000&l=9200000000000000000
  @GetMapping("/test2")
  ...
  // 메모리 크기에 따른 값의 유효범위
  // 테스트 URL
  // http://localhost:8080/lang/variable/exam1/test3?f=987.6543&d=987654.32123456789876
  @GetMapping("/test3")
