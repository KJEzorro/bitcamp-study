...
public class Exam4 {
  ...
  // 테스트:
  // /static/lang/variable/exam4/test1.html
  @GetMapping("/test1")
  public String test1(int v1, int v2, String op) {
    ...
    // "서버측 렌더링(server-side rendering)"라 부른다
  ...
  // 테스트:
  // /static/lang/variable/exam4/test2.html
  @GetMapping("/test2")
  ...
  // 테스트:
  // /static/lang/variable/exam4/test3.html
  @GetMapping("/test3")
  public Object test3() {
    String[] names = {"홍길동", "임꺽정", "유관순", "안중근", "윤봉길"};
    return names; // 스프링부트는 이 메서드가 리턴한 배열을 JSON형식의 문자열로 바꿔 응답한다.
  }
}
