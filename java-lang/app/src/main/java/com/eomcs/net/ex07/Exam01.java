...
public class Exam01 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // => [프로토콜]://서버주소:포트번호/자원의경로?파라미터명=값&파라미터명=값 ( = URL)
    // - 프로토콜: http(80), https(443), ftp(21/20) 등 (다른 포트번호를 써도 된다)
    // - 서버주소: IP 주소(192.168.0.1), 도메인명(www.bitcamp.co.kr)
    // - 포트번호: 80 또는 443(생략할 수 있다), 8080(프록시 서버, 생략 불가) 등
