// 바이너리 파일을 텍스트 형식으로 저장하기 : Base64 클래스 (바이너리 데이터를 텍스트 형식으로 변환하는 알고리즘(버퍼))
...
public class Exam0120 {
  public static void main(String[] args) throws Exception {
    ...
    FileReader in = new FileReader("./temp/111.txt");
    FileOutputStream out = new FileOutputStream("./temp/111x.jpg");
