...
public class Exam0210 {
  // 중첩 클래스 (nested class)
  // => '''특정 클래스 안에서만 사용되는 클래스'''가 있다면 중첩 클래스로 선언하라.
  // => 즉 '''노출 범위를 좁히는 것이 유지보수에 좋다.'''
  //
  // 1) static nested class 
  // => 바깥 클래스의 인스턴스에 '''종속되지 않는''' 클래스.
  // => top level class 와 '''동일하게 사용'''한다.
  static class A {} // 이 클래스도 스태틱 멤버다.
