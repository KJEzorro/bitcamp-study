...
public class Exam0510 {
  ...
  static void m1() {
    // 패키지 멤버 클래스는 '''그 패키지에 소속된 누구라도 사용'''할 수 있다.
    // 같은 패키지가 아니라도 '''공개된 패키지 멤버는 누구라도 사용'''할 수 있다.
    A obj1 = new A();
