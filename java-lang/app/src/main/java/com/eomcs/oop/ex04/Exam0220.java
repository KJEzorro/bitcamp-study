...
public class Exam0220 {
  public static void main(String[] args) throws Exception {
    ...
    // 스태틱 메서드 = 클래스 메서드 사용
    int v2 = Integer.parseInt("1280"); // String 객체를 int로 변환
    String s1 = Integer.toBinaryString(77); // int 값을 2진수로
    String s2 = Integer.toOctalString(77); // int 값을 8진수로
    String s3 = Integer.toHexString(77); // int 값을 16진수로
