// 오버라이딩(overriding) - 오버라이딩과 super 키워드 (현재 클래스의 기준)
...
public class Exam0411 {
  ...
  public static void main(String[] args) {
    A3 obj = new A3();
    obj.test();  // A2의 test() 호출 - 상속받은 메서드

    // 현재클래스의 기준?
    // => this의 실제 타입부터 찾아 올라간다. --> test()를 호출할 때 넘겨준 객체의 주소,타입(A3)
    // 
    // super 클래스의 기준?
    // => 메서드가 소속된 클래스의 super 클래스부터 찾아올라간다. --> test()가 소속된 클래스의 super클래스
  }
}
