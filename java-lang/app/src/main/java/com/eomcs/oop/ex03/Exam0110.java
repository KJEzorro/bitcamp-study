...
public class Exam0110 {
  ...
  static class A {
    ...
    // => '''Heap 영역에 생성'''된다.
    // => '''static이 붙지 않는다.'''
    int v1; // 4바이트 int 값을 저장할 '''메모리를 만들라'''는 명령!
    boolean v2; // true/false 논리값을 저장할 '''메모리를 만들라'''는 명령!
  ...
  public static void main(String[] args) {
    ...
    A obj2 = new A(); // 메서드 정의는 ''new가 하는 일이 아니다.''
    A obj3 = new A();

    // 이렇게 생성된 메모리를 "인스턴스", "객체"라고 부른다.
    // 이 인스턴스의 주소를 저장하는 obj1, obj2, obj3를 "레퍼런스"라 부른다.
    // 인스턴스가 생성될 때 만들어지는 v1, v2를 변수를 "인스턴스 변수"라 부른다. heap에 생성
...
// 인스턴스 변수는 '''new 명령을 실행할 때 마다 생성'''되기 때문에
