...
public class Exam0130 {
  ...
  static class Score {
    ...
    // - 이렇게 전달된 '''인스턴스 주소'''는 메서드에 내장된 '''this라는 변수에 자동 복사'''된다.
...
// - 특정 인스턴스가 아닌 '''모든 인스턴스에 대해 작업을 수행할 때 사용'''하는 메서드이다.
// - 사용법
// 클래스명.메서드명();
//
...
// 다른 개발자가 인스턴스 메서드인 줄 알고헷갈려 한다.
//
//
// 2) 인스턴스 메서드(non-static mathod)
// - 메서드 언부에 static이 붙지 않는다.
// - '''특정 인스턴스에 대해 작업을 수행할 때 사용'''하는 메서드이다.
// - 사용법
// 레퍼런스.메서드명();
//
// 정리!
// 사용자 정의 데이터 타입에서
// '''인스턴스의 값'''을 다루는 연산자를 정의할 때는
// '''인스턴스 메서드'''로 만드는 것이 사용하기 편하다!
